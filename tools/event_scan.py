...
EVENT_CATEGORIES = {
    ...
    "业绩": ["业绩预告", "年报", "半年报", "季报", "净利润", "营业收入", "预增", "预减", "扭亏"],
    "澄清/回应": ["澄清", "回应", "辟谣", "说明公告", "问询函回复"],
    "减持/风险": ["减持", "质押", "立案", "处罚", "退市风险", "诉讼"],
    "政策/制裁": ["FCC", "禁令", "制裁", "出口管制", "实体清单", "关税", "商务部", "国防部",
                  "限制进口", "审查", "反垄断"],
    "订单/产能": ["订单", "中标", "合同", "产能", "扩产", "投产", "客户", "定点"],
    "技术/产品": ["量产", "新品", "发布", "技术", "研发", "认证", "1.6T", "800G", "硅光"],
    "资本运作": ["定增", "并购", "重组", "可转债", "分红", "送转"],
    "机构动态": ["调研", "机构", "基金", "评级", "目标价"],
}

...
# ===== v3.0: 范式×生命周期 2D 权重矩阵 (18种模板) =====
PARADIGM_WEIGHTS = {
    ("hardware_tech", "加速期"): {"L1_risk": 0.15, "L2_moat": 0.25, "L3_efficiency": 0.35, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("hardware_tech", "成熟期"): {"L1_risk": 0.15, "L2_moat": 0.20, "L3_efficiency": 0.40, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("hardware_tech", "导入期"): {"L1_risk": 0.10, "L2_moat": 0.30, "L3_efficiency": 0.15, "L4_industry": 0.30, "L5_expectation": 0.15},
    ("software_saas", "加速期"): {"L1_risk": 0.15, "L2_moat": 0.40, "L3_efficiency": 0.20, "L4_industry": 0.10, "L5_expectation": 0.15},
    ("software_saas", "成熟期"): {"L1_risk": 0.15, "L2_moat": 0.30, "L3_efficiency": 0.30, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("software_saas", "导入期"): {"L1_risk": 0.10, "L2_moat": 0.30, "L3_efficiency": 0.10, "L4_industry": 0.25, "L5_expectation": 0.25},
    ("medical_innovation", "加速期"): {"L1_risk": 0.15, "L2_moat": 0.35, "L3_efficiency": 0.20, "L4_industry": 0.15, "L5_expectation": 0.15},
    ("medical_innovation", "成熟期"): {"L1_risk": 0.15, "L2_moat": 0.25, "L3_efficiency": 0.35, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("medical_innovation", "导入期"): {"L1_risk": 0.10, "L2_moat": 0.25, "L3_efficiency": 0.10, "L4_industry": 0.30, "L5_expectation": 0.25},
    ("consumer_brand", "加速期"): {"L1_risk": 0.15, "L2_moat": 0.35, "L3_efficiency": 0.25, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("consumer_brand", "成熟期"): {"L1_risk": 0.15, "L2_moat": 0.25, "L3_efficiency": 0.40, "L4_industry": 0.10, "L5_expectation": 0.10},
    ("consumer_brand", "导入期"): {"L1_risk": 0.10, "L2_moat": 0.30, "L3_efficiency": 0.15, "L4_industry": 0.30, "L5_expectation": 0.15},
    ("industrial_manufacturing", "加速期"): {"L1_risk": 0.20, "L2_moat": 0.20, "L3_efficiency": 0.30, "L4_industry": 0.20, "L5_expectation": 0.10},
    ("industrial_manufacturing", "成熟期"): {"L1_risk": 0.15, "L2_moat": 0.15, "L3_efficiency": 0.45, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("industrial_manufacturing", "导入期"): {"L1_risk": 0.10, "L2_moat": 0.25, "L3_efficiency": 0.15, "L4_industry": 0.35, "L5_expectation": 0.15},
    ("generic", "加速期"): {"L1_risk": 0.20, "L2_moat": 0.30, "L3_efficiency": 0.25, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("generic", "成熟期"): {"L1_risk": 0.15, "L2_moat": 0.20, "L3_efficiency": 0.40, "L4_industry": 0.15, "L5_expectation": 0.10},
    ("generic", "导入期"): {"L1_risk": 0.10, "L2_moat": 0.30, "L3_efficiency": 0.10, "L4_industry": 0.35, "L5_expectation": 0.15},
}
...
# ===== P1-1: 成长股行业黑名单 =====
# 这些行业的营收/利润增长主要来自商品价格或宏观周期，不是内生飞轮成长。
# 精确到三级行业关键词，避免误伤产业链上下游（如"锂"不在此列，电池产业链有真成长）。
GROWTH_INCOMPATIBLE_INDUSTRIES = {
    "黄金", "铝", "铜", "铅锌", "稀土",
    "煤炭开采", "焦炭加工", "油气开采", "石油加工",
    "工程咨询服务",
}

# 商品行业（用于 lifecycle 预检，防止价格脉冲被误判为加速期）
